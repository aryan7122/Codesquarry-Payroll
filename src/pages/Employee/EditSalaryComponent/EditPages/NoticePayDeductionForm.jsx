...
const NoticePayDeductionForm = ({ showPopup, setShowPopup }) => {
    const [formData, setFormData] = useState({
        earningType: "Notice Pay Deduction",
        earningName: "Notice Pay Deduction",
        nameInPayslip: "Notice Pay Deduction",
        calculationType: "One time Deduction",
        // percentage: "",
        // isActive: false,
        // taxable: true,
        // taxableEarning: true,
...
export default NoticePayDeductionForm;

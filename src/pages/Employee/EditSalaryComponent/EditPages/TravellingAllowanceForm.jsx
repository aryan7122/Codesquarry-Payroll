...
const TravellingAllowanceForm = ({ showPopup, setShowPopup }) => {
    const [formData, setFormData] = useState({
        earningType: "Travelling Allowancee",
        earningName: "Travelling Allowance",
        nameInPayslip: "Travelling Allowance",
    ...
    const popupData = {
        ...
        content: [
            {
                heading: "What is Travelling Allowance?",
                text: "Travelling Allowance is a fixed amount of money paid to the employee for the travelling and other expenses during a business tour. It usually includes the price of travel tickets, hotel bill and meal expenses, etc."
            },
            {

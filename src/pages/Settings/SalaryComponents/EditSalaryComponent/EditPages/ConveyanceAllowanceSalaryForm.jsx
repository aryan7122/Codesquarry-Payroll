...
const ConveyanceAllowanceSalaryForm = ({ showPopup, setShowPopup }) => {
    const [formData, setFormData] = useState({
        earningType: "Conveyance Allowance",
        earningName: "Conveyance Allowance",
        nameInPayslip: "Conveyance Allowance",
    ...
    const popupData = {
        ...
        content: [
            {
                heading: "What is Conveyance Allowance?",
                text: "Conveyance Allowance is granted to meet the travel expenditures while performing office duty within the city."
            },
            {
                heading: "What are the tax exemption rules?",
                text: "Conveyance Allowance is exempt from taxes to the extent of actual expense incurred."
            },
...
export default ConveyanceAllowanceSalaryForm;

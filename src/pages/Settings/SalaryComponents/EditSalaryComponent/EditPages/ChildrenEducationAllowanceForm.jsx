...
const ChildrenEducationAllowanceForm = ({ showPopup, setShowPopup }) => {
    const [formData, setFormData] = useState({
        earningType: "Children Education Allowance",
        earningName: "Children Education Allowance",
        nameInPayslip: "Children Education Allowance",
    ...
    const popupData = {
        ...
        content: [
            {
                heading: "What is Children Education Allowance?",
                text: "Children Education Allowance is an allowance provided to Government employees in India for their children’s schooling and hostel expenses."
            },
            {
                heading: "What are the tax exemption rules?",
                text: "Children Education Allowance is exempt from taxes up to ₹100/child, for a maximum of two children. Any amount given in excess of that will be taxable. Employees don't have to submit bills in order to claim this tax exemption."
            },
...
export default ChildrenEducationAllowanceForm;
